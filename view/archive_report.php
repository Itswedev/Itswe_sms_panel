              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Campaigns</h4><span id="page_name" style="display:none;">Archive Report</span>  
                  </div>
                  <div class="card-body">
                  <table border="0" cellspacing="5" cellpadding="5">
                    ...
                    <div class="table-responsive">
                      <table class="display responsive  w-100" id="archive_report_tbl">
                        <thead>
                          <tr>
                          <th class="sort w-auto" data-sort="">Job Id</th>
                                        ...
                                        <th class="sort w-auto" data-sort="">Template ID</th>
                                        <th class="sort" data-sort="" width="35%">Message</th>
...
<!--     
    ...
    <script src="assets2/js/plugins-init/pickadate-init.js"></script> -->
 
        <?php include_once('include/modal_forms/repush_modal.php'); ?>
        <script>
    document.addEventListener("DOMContentLoaded", function() {
     flatpickr(".datetimepicker", {
       ...
       dateFormat: "Y-m-d", // Set the desired date format
        ...
        <script src="assets/js/report.js?=<?=time();?>"></script>
        <script src="assets/js/repush.js?=<?=time();?>"></script>
