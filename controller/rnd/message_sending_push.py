...
def send_master_tbl(message_id,job_id):
        ...
        if send_count_count > 0 :
            ...
            #     send_sms_qry = "INSERT INTO `otp_send` (`momt`, `sender`, `receiver`, `msgdata`, `smsc_id`,`sms_type`,  `dlr_mask`, `dlr_url`, `boxc_id`, `coding`, `charset`,`udh`, `meta_data`) values "+insert_send_sms_val
            # else:
        ...
        while True:
            try:
                ...
                if(send_sms_count < 50000):
                    job_tbl_qry = "SELECT id,job_id FROM " + send_job_tbl + " WHERE is_picked=0 AND (is_scheduled=0 ) and route!='OTP' and job_id='QxRCoLEKHfyjBa0'"
