...
?>
        ...
        ?>
                                    ...
                                    <button type="button" class="btn btn-primary" id="download_daily_report_btn" onclick="downloadTableAsCSV('send_job_details_tbl', 'api_report.csv')">Download
    ...
    document.addEventListener("DOMContentLoaded", function() {
     flatpickr(".datetimepicker", {
       ...
       // Set your maximum date here
        ...
        <script src="assets/js/api_job_report_uat.js?=<?=time();?>"></script>