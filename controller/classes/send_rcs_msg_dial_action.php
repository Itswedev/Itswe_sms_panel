<?php
session_start();
$log_file = "/var/www/html/itswe_panel/error/logfiles/send_rcs_msg_dial_action.log";
...
$dial_title=$data['dial_title'];
 ...
 $i=0;
  foreach($mob_num_data as $values) {
        ...
        $array = array('mobile_number' => $values,'msg' => $msg,'dlr_url'=>$dlr_url_data[$i],'dial_number'=>$dial_number,'dial_title'=>$dial_title);
       	
        //$filename="rcs_send_msg_".time().".json";
        $fname="rcs_send_sms_dial_action_data_".time().".json";
        ...
        $pyout = exec("/var/www/html/itswe_panel/rcs/rcs-env/bin/python /var/www/html/itswe_panel/rcs/dial_action.py $fname $user_id", $outp, $return);
