  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add RCS Template</h5>
      ...
      <div class="modal-body">
        ...
        <form id="addtemplateForm">
            <div class="container-fluid">
              <input type="hidden" name="type" value="add_template"  />
          ...
          <input type="hidden" name="userid" value="<?php echo $_SESSION['user_id']; ?>"  />
              ...
              <div class="row">
                ...
                <div class="col-md-4 "><label for="recipient-name" class="col-form-label">Template Type:</label></div>
                <div class="col-md-6">
                  <select required class="form-control" id="template_type" name="template_type" data-placeholder="Select a template type..." >
                    <option value="">Select Template Type</option>
                    <option value="simple_text">Simple Text</option>
                    <option value="rich_card">Rich Card / Carousal</option>
              ...
              <div class="row">
                ...
                <div class="col-md-6"><input type="text" class="form-control" name="template_name"  id="template_name" value="" placeholder="Template Name" required></div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="addRCSTemplate">Save</button>
      </div>
      </form>
    </div>
  </div>
