...
<div class="card mb-3">
    ...
    <div class="card-body position-relative">
      <div class="row">
        <div class="col-lg-4">
          <h3 id="page_name"># Voice Call Report</h3>  
        </div>
        <div class="col-lg-8">
        </div>      
      </div>
...
<div class="row g-3 mb-3">
    <div class="col-lg-12">
                    ...
                    <div id="tableExample2" data-list='{"valueNames":["name","email","age"],"page":5,"pagination":true}'>
                        <div class="table-responsive scrollbar">
                            ...
                            <tbody>
                                ...
                                <td>
                                    <input class="form-control datetimepicker" id="frmDate" type="text" placeholder="yyyy-mm-dd"  data-options='{"disableMobile":true,"enableTime":false,"dateFormat":"Y-m-d","minDate": "<?php echo $minDate; ?>","maxDate": "<?php echo $maxDate; ?>"}' name="min" aria-label="frmDate" aria-describedby="basic-addon1" style="width:80%;"   onChange="searchData_report()"/></td>
                                    <!-- <input type="date" id="frmDate" name="min" ></td> -->
                                <td>To&nbsp:&nbsp&nbsp</td>
                                <td>
                                    <input class="form-control datetimepicker" id="toDate" type="text" placeholder="yyyy-mm-dd"  data-options='{"disableMobile":true,"enableTime":false,"dateFormat":"Y-m-d","minDate": "<?php echo $minDate; ?>","maxDate": "<?php echo $maxDate; ?>"}' name="max" aria-label="toDate" aria-describedby="basic-addon1" style="width:80%;" onChange="searchData_report()"/></td>
        ...
        ?>
                            ...
                            <table class="table table-bordered table-striped fs--1 mb-0" id="voice_call_summary_tbl">
                                <thead class="bg-200 text-900">
                                    <tr>
                                        ...
                                        <th class="sort w-auto" data-sort="">Route</th>
                                        <th class="sort w-auto" data-sort="">Caller ID</th>
                                        <th class="sort w-auto" data-sort="">Campaign Name</th>
                                        <th class="sort" data-sort="" width="35%">File Name</th>
                                        <th class="sort w-auto" data-sort="">Bill Credit</th>
                                         <th class="sort w-auto" data-sort="">Numbers Count</th>
                                       
                                        <!--  <th class="sort w-auto" data-sort="">Delivery Count</th> -->
                                        <!-- <th class="sort w-auto" data-sort="">Status</th> -->
                                    </tr>
                                </thead>
                                <tbody class="voice_call_summary" id="voice_call_summary">
