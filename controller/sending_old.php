...
$log_file = "../error/logfiles/sending.log";
...
if (isset($_POST['type']) && $_POST['type'] == 'sendSMSsave') { 
...
if ($rs['status'] == true && $rs['msg'] == 'Success') {
    ...
    else
    {
       ...
       // header("Location:../dashboard.php?page=bulksms"); exit();
        ...
        $_SESSION['err'] = "NACK/0x00000401/Vendor-specific error, please refer to your sms provider";

        echo "NACK/0x00000401/Vendor-specific error, please refer to your sms provider";
...
if (isset($_POST['type']) && $_POST['type'] == 'sendDynamicSMSSave') {  
    $rs = $obj->advCustomizeSmsSave();    
    $dlr_url=$rs['dlr_url'];
   // print_r($rs);
...
if (isset($_POST['type']) && $_POST['type'] == 'sendRCSSMS') {  
