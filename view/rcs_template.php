         ...
         <div class="col-sm-12">
           <div class="card">
             <div class="card-header">
               <h4>RCS Template</h4>
               <button id="gradientButtons1" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa-solid fa-circle-plus fa-fw" style="margin-right: 8px;"></i>Add RCS Template</button>
             </div>
             <div class="card-body">
               <div class="table-responsive theme-scrollbar">
                 <table class="display" id="rcs_temp_tbl">
...
<?php include_once('include/modal_forms/rcs_template_modal.php'); ?>
<!-- <?php //include_once('include/included_js.php'); ?> -->
<script type="text/javascript" src="assets/js/chosen.jquery.js?=<?=time();?>"></script>

<script src="assets/js/rcs_template.js?=<?=time();?>"></script>
