                    ...
                    <!-- message text -->
                      ...
                      <div class="row"> 
                        <div class="col">
                          <div class="mb-3"> 
                            ...
                            <div class="row"> 
                            <div class="col">  
                            <label class="form-label" for="formFileSimple">DLT Template</label>
                      ...
                      <div class="row">
                        ...
                        <input name="original_url" type="text" id="original_url"  class="form-control div_track" style="width:40%;display: none;" readonly />
                              ...
                              <label class="form-label" for="exampleInputPassword6" style="margin-left: 5px;">Tracking URL</label>
                          </div>
                          </div>
                          <div class="row"> 
                          <div class="col">
                          <div class="mb-3"> 
                            <div class="row">
                            <div class="col">
                            <button class="btn btn-primary-gradien mt-3 btn_send" id="send_sms" name="btn_send_sms" type="submit" value="send now">Send Now</button>
                            </div>
                            <div class="col">
                            <button class="btn btn-primary-gradien mt-3" type="button" id="schedule_later_btn">Schedule</button>
                            </div>
                            <div class="col">
                            <input class="btn btn-primary-gradien mt-3" type="reset" value="Cancel">
                            </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col"><div class="card-body">
                       <div class="row">
                        <div class="col">
                          <!-- <div class="mb-4">
                            <label class="form-label" for="exampleFormControlSelect7">Groups</label>
                            <div class="row">
                              <div class="col">
                                <div class="form-check">
                              ...
                              <div class="col">
                                <div class="form-check">
                                <label class="form-check-label" for="flexCheckDefault">Total Contacts</label>
                                </div>
                              </div>
                          </div> -->
                          <!-- <div class="row">
                              <div class="col">
                                ...
                                <label class="form-check-label" for="flexCheckDefault">A1</label>
                                </div>
                              </div>
                              <div class="col">
                                <div class="form-check">
                                <label class="form-check-label" for="flexCheckDefault">400</label>
                                </div>
                              </div>
                          </div> -->
                          <!-- <div class="row">
                              <div class="col">
                                <div class="form-check">
                                <input class="form-check-input" id="flexCheckDefault" type="checkbox" value="">
                                <label class="form-check-label" for="flexCheckDefault">B1</label>
                                </div>
                              </div>
                              <div class="col">
                                <div class="form-check">
                                <label class="form-check-label" for="flexCheckDefault">600</label>
                                </div>
                              </div>
                          </div> -->
                          <!-- <div class="row">
                              <div class="col">
                                <div class="form-check">
                                <button id="gradientButtons1" class="btn btn-primary-gradien" style="
                                ">Add Group</button>
                                </div>
                              </div>
                              <div class="col">
                      ...
                      <div class="row">
                        <div class="col">
                        <div class="progress sm-progress-bar overflow-visible" style="width: 77%;">
                          ...
                          <label class="form-label" for="formFileSimple">Upload (csv or xlsx) &nbsp;<a href="sample_csv_files/sample-bulk.csv" >download sample </a></label>
                              <div class="row">
                                <div class="col">
                                  <input class="form-control btn-pill px-4" id="uploadfile" name="uploadfile" type="file">
                                </div>
                                <div class="col">
                                  <button type="button" class="csv_xls_txt btn btn-outline-primary" value="" id="importBtn_bulk" style="height:36px;">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            <label class="form-label" for="exampleInputPassword6">Group Contacts</label>
                            <select id="group_id" class="form-select btn-pill" name='group_id[]' style="width:80%;">                         
                          </select>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row"> 
                        <div class="col">
                          ...
                          <div class="col">
                          <button id="send_test_msg" class="btn btn-primary-gradien" name="send_test_msg" type="submit" value="btn_test" >Test Message</button>
                          </div>
                          </div>
                          </div>
                        </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
     flatpickr(".datetimepicker", {
       ...
       // Set your maximum date here
        ...
        <script src="assets/js/bulk_sms_function_uat.js?=<?=time();?>"></script>
