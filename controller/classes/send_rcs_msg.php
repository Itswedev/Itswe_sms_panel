<?php
session_start();
/*$log_file = "/var/www/html/itswe_panel/error/logfiles/send_rcs_msg.log";
...
$msg=$data['msg'];
 ...
 $i=0;
  foreach($mob_num_data as $values) {
        ...
        $array = array('mobile_number' => $values,'msg' => $msg,'dlr_url'=>$dlr_url_data[$i]);
        ...
        fclose($fp);
         ...
         $pyout = exec("/var/www/html/itswe_panel/rcs/rcs-env/bin/python /var/www/html/itswe_panel/rcs/send_simple_text.py rcs_send_sms1.json $user_id >> /var/www/html/itswe_panel/error/rcs_logs/rcs_simple_txt.log", $outp, $return);
