...
$(function() {
	...
	if(page_name=='Campaign wise Summary Report')
	{
	...
	else if(page_name=='Campaign Detail Report')
	{
            load_campaign_detail_report();
	}
 ...
 function searchData() {
	...
	$(document).on("click",".report_type", function (e) {
        ...
        var operator_name = $(this).data('operator');

        var uid = $(this).data('uid');
   		//sessionStorage.setItem("report_type",report_status);
   		window.location.href="dashboard.php?page=campaign_dtl_report&report_type="+report_status+"&user_role="+user_role+"&uid="+uid+"&selected_role="+selected_role+"&operator_name="+operator_name;
});
    ...
    $(document).on("change","#user_role_dropdown", function (e) {
        ...
        $(document).on("click","#submit_report_btn", function (e) {
...
function load_campaign_detail_report()
{
 ...
 var uid=$("#uid").val();
        ...
        "responsive": true,
         "ajax": {
                    "type":"POST",
                    "url":full_url+"/controller/campaign_controller.php",
                    "data":function (post) {
                                ...
                                post.operator_name=operator_name; 
                                if(frmDate!="" && toDate!="")
                                {
...
function load_today_summary_report()
{
    ...
    else
    {
      ...
      if(frmDate!="" && toDate!="")
      {
        dataString+= '&frmDate='+frmDate+'&toDate='+toDate;
      }
