                  ...
                  <hr width="100%">     
                       ...
                       <div class="row" style="margin-left:1%;">
                        <div class="col">
                          <div class="mb-4">
                            ...
                            <label class="form-label" for="exampleFormControlSelect7">Upload File (csv and xlsx can be upload)</label> 
                            ...
                            position: relative;
                            left: 26%;margin-top: -5.2%;
                            ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-upload" style="width:22%; margin-left:-8%; margin-right:6%; margin-top:-5%"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>Upload 
                            </button> 
                              <br>
                              ...
                              Mobile Number count:<span id="mobile_count"></span>
                          </div>
                        </div>
                    ...
                    <!-- <option value=""></option> -->
                      ...
                      <div class="row">
                        <div class="col">
                          ...
                          <div class="mb-3"> 
                            <div class="row">
                            <div class="col">
                            <button class="btn btn-outline-primary btn-sm mb-1" type="button" title="btn btn-outline-primary-2x" style="border-radius:20px">Characters: <span class="length" id="characters"> 0 </span></button>
                            </div>
                            <div class="col">
                            <button class="btn btn-outline-primary btn-sm mb-1" type="button" title="btn btn-outline-primary-2x" style="border-radius:20px;">Sms Count: <span class="messages" id="smsCount" name="txtMessageCount">0</span></button>
                            </div>
                            <div class="col">
                            <button class="btn btn-outline-primary btn-sm mb-1" type="button" title="btn btn-outline-primary-2x" style="border-radius:20px;" id="preview" name="preview" >Text Preview</button>
                            </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                            ...
                            <div class="col">
                            <button class="btn btn-primary" id="dynamic_sms_btn" type="submit"><i class="fa-solid fa-paper-plane fa-fw" style="margin-right: 8px;"></i>Send Now</button>
                            </div>
                            <div class="col">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            <label class="form-label" for="exampleFormControlInput5">Template</label>
                      ...
                      <div class="form-check form-switch form-check-inline">
                              ...
                              <label class="form-label" for="exampleInputPassword6">Tracking Link</label>
                      ...
                      <div class="form-check form-switch form-check-inline">
                              ...
                              <label class="form-label" for="exampleInputPassword6">Dynamic Tracking Link</label>
                      ...
                      <div class="row track_url" style="display:none;">
                        ...
                        <div class="row">
                          <div class="col">
                          <div class="mb-3">
                            <label class="form-label" for="exampleInputPassword6" style="margin-top:2.5%";>Campaign Name</label>
...
?>
 ...
 <script src="assets/js/ajaxupload_dynamic.js?=<?=time();?>"></script>
