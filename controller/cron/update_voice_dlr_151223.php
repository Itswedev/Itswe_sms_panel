...
echo "\n ";
	...
	echo "\n ";
	 echo $update_master_tbl="update voice_call set status='$status'  ,call_ans_time='$call_ans_time',call_connect_time='$call_connect_time',call_disconnect_time='$call_disconnect_time',call_duration='$call_duration',`input`='$input' where trans_id='$trans_id' and mobile_number='$mobile_number'";
echo "\n ";
