                        ...
                        <table border="0" cellspacing="5" cellpadding="5">
                            ...
                            ?>
                                 <td style="vertical-align: middle;">Select Role</td>
                                                        <td>
                                                           <select class="form-control" id="user_role_dropdown" style="width:100%;" name="selected_role"><option value="">Select Role</option>
                                              ...
                                              <option value="User">User</option>
                                                        ...
                                                        <td>
                                                            <select class="form-control" id="user_dropdown" name="select_user_id" style="width:100%;"><option value="">Select User</option></select>  
                                                        </td>
                                <?php
                                  }
