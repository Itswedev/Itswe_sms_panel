...
$kolpol_dlr = "select * from kolpol_dlr where date(created_date)='".$today_date."' and update_dlr='0' limit 5000";
...
while ($row=mysqli_fetch_array($rs_job)) {
   ...
   $mobile_number = $row['mobile_number'];
	...
	$msg_job_id = $row['msg_job_id'];
	 ...
	 $kolpol_master_dlr = "select * from az_sendnumbers where date(sent_at)='".$today_date."' and msg_job_id='$msg_job_id' and status!='Submitted'";
//$kolpol_dlr = "select * from kolpol_dlr where date(created_date)>'2023-07-16' and update_dlr='0' ";
