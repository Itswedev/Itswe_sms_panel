...
var wizardInit = function wizardInit() {
  ...
  wizards.forEach(function (wizard) {
    ...
    var mobile = wizard.querySelector('[data-wizard-validate-mobile]');
    var message = wizard.querySelector('[data-wizard-validate-message]');
    ...
    nextButton.addEventListener('click', function () {
     if (!(inputEmail.value)|| !mobile.value || !message.value) {
        form.classList.add('was-validated');
      } else {
