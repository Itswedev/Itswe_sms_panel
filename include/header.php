		...
		<div class="chatbox">
			...
			<div class="custom-tab-1">
				...
				<ul class="nav nav-tabs">
					...
					<li class="nav-item">
						<a class="nav-link active" data-bs-toggle="tab" href="#alerts">Balance</a>
					</li>
					<!-- <li class="nav-item">
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="assets2/images/avatar/1.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="assets2/images/avatar/2.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="assets2/images/avatar/3.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="assets2/images/avatar/4.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="assets2/images/avatar/5.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="assets2/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
										<img src="assets2/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
					...
					<div class="tab-pane fade active show" id="alerts">
						<div class="card mb-sm-3 mb-md-0 contacts_card">
							...
							<div class="card-body contacts_body p-0 dz-scroll" id="DZ_W_Contacts_Body1">
								<ul class="contacts">
									<li class="name-first-letter">SMS</li>
									<ul class="messages" id="balance_sec">
                    
                    
					
				  					</ul>
									
									<li class="name-first-letter">RCS</li>
									<li>
										<div class="d-flex bd-highlight">
									...
									<li class="name-first-letter">Voice</li>
									<li>
										<div class="d-flex bd-highlight">
										...
										<a class="nav-link" href="javascript:void(0);" role="button"
											...
											<div class="header-info2 d-flex align-items-center">
												<div class="header-media">
													<img src="assets2/images/user.jpg" alt="">
												</div>
											</div>
										</a>
										<div class="dropdown-menu dropdown-menu-end">
											<div class="card border-0 mb-0">
												<div class="card-header py-2">
													<div class="products">
														<img src="assets2/images/user.jpg" class="avatar avatar-md" alt="">
														<div>
												...
												<div class="card-body px-0 py-2">
													<a href="<?php echo $baseURL;?>dashboard.php?page=profile" class="dropdown-item ai-icon ">
												...
												<div class="card-footer px-0 py-2">
													<a href="<?php echo $baseURL;?>dashboard.php?page=settings" class="dropdown-item ai-icon ">
														<svg width="20" height="20" viewBox="0 0 24 24" fill="none"
															xmlns="http://www.w3.org/2000/svg">
															<path fill-rule="evenodd" clip-rule="evenodd"
