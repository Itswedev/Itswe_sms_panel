...
update_user_summary_table();
    function update_user_summary_table()
    {
        ...
        global $dbc;
        $sendtabledetals = 'az_sendnumbers202402';
        ...
        for($i=1;$i<=28;$i++)
        {
        echo $today='2024-02-'.$i;
        echo "\n";

       $sql="select sum(msgcredit) as msgcredit,userids,status,route,senderid,service_id,sent_at,parent_id from az_sendnumbers202304 where date(sent_at)='$today' and schedule_sent=1 group by userids,status,route,senderid";
