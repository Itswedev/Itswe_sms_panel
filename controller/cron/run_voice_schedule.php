...
$send_msg_file = "/var/www/html/itswe_panel/controller/classes/voice_scheduler.json";
...
if(isset($schedule_time_arr))
{
	for($i=0;$i<count($schedule_time_arr);$i++) {
		...
		if($schedule_time==$today_dt)
		{
			...
			exec("php /var/www/html/itswe_panel/controller/classes/schedule_voice/$executable_php $msg_id > /dev/null 2>/dev/null & > /var/www/html/itswe_panel/controller/classes/schedule_voice/log.txt"); 
		}
		else
		{
			echo 0;
