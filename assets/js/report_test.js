...
$(function() {
 ...
 var user_role=$("#user_role").val();
     ...
     else if(page_name=='download report')
    {
       ...
       // setInterval(load_download_data,30000);
       // load_download_data();
         ...
         $(document).on('click','#search_submit',function(){
                ...
                $.ajax({
                    url: full_url+'/controller/report_controller_test.php',
                    type: 'post',
                    cache: false, 
                    ...
                    success: function(data){
                       ...
                       if(resp==1)
                        {
                            swal.fire('','Data downloading is processing','success').then((value) => {
                                location.reload();
                               });
                        }
...
function load_download_data()
{
    ...
    $.ajax({
        ...
        type: 'post',
        cache: false, 
        data:'list_type=load_download_report',
        success: function(data){
        console.log(data);
           if(data!=0)
           {
...
function load_users()
{
    alert('asd');
    $("#user_dropdown").html('');
    $("#user_dropdown").append("<option>User1</option>");
